export type BeatKey =
    | "action" | "decision" | "desire" | "conflict" | "obstacle" | "climax" | "resolution"
    | "reveal" | "realization" | "exposition" | "foreshadow" | "setup" | "payoff"
    | "emotion" | "suppression" | "vulnerability" | "power" | "shift" | "intimacy" | "alienation"
    | "dialogue" | "nonverbal" | "interaction" | "agreement" | "disagreement" | "test" | "reversal"
    | "atmosphere" | "discovery" | "loss" | "arrival" | "departure" | "transition"
    | "inciting" | "turning point" | "mirror" | "bridge" | "suspense" | "release"
    | "thematic statement" | "counterpoint" | "test of belief" | "transformation" | "thematic mirror" | "sacrifice" | "thematic revelation" | "thematic resolution";

export type BeatDef = { key: BeatKey; label: string; color: string; family: "Red" | "Blue" | "Purple" | "Green" | "Orange" | "Gray" | "Gold" };
...
export const BEAT_FAMILY: Record<BeatKey, BeatDef["family"]> =
    Object.fromEntries(BEATS.map(b => [b.key, b.family])) as Record<BeatKey, BeatDef["family"]>;
